...
class Agents:
    def __init__(self, args):
        ...
        if args.alg == 'vdn':
            from StarCraft.policy.vdn import VDN
            self.policy = VDN(args)
        elif args.alg == 'iql':
            from StarCraft.policy.iql import IQL
            self.policy = IQL(args)
        elif args.alg == 'qmix':
            from StarCraft.policy.qmix import QMIX
            self.policy = QMIX(args)
        elif args.alg == 'coma':
            from StarCraft.policy.coma import COMA
            self.policy = COMA(args)
        elif args.alg == 'qtran_alt':
            from StarCraft.policy.qtran_alt import QtranAlt
            self.policy = QtranAlt(args)
        elif args.alg == 'qtran_base':
            from StarCraft.policy.qtran_base import QtranBase
            self.policy = QtranBase(args)
        elif args.alg == 'maven':
            from StarCraft.policy.maven import MAVEN
            self.policy = MAVEN(args)
        elif args.alg == 'central_v':
            from StarCraft.policy.central_v import CentralV
            self.policy = CentralV(args)
        elif args.alg == 'reinforce':
            from StarCraft.policy.reinforce import Reinforce
