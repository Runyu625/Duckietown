""" Defines NatNetClient Python Class

Based on: https://github.com/paparazzi/paparazzi/blob/master/sw/ground_segment/python/natnet3.x/NatNetClient.py
"""
...
class NatNetClient:
    def __init__(self, server, multicast, commandPort,
                 dataPort, rigidBodyListener, newFrameListener,
                 rigidBodyListListener=None, verbose=False,):
...
(
                ...
                if (
                    self.__natNetStreamVersion[0] >= 3
                    or self.__natNetStreamVersion[0] == 0
                ):
