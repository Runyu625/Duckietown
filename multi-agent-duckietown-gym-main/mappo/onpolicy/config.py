...
def get_config():
    ...
    parser.add_argument("--num_env_steps", type=int, default=400000,
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='duckietown', choices=['warehouse', 'flock', 'lb-foraging', 'duckietown-discrete', 'duckietown'], help="specify the name of environment")
    ...
    # New parameters
    parser.add_argument("--graph_ml", type=str, default=False, help="Use graph neural network")
    parser.add_argument("--attention", type=str, default=True, help="Use attentional graph neural network")
    parser.add_argument("--gnn_filter_taps", type=int, default=2, help="Filter taps of GNN")
    parser.add_argument("--n_attention_heads", type=int, default=1, help="Number of attention heads")

    parser.add_argument("--num_agents", type=int, default=1, help="Number of agents")

    #Environment:RWARE parameters
    parser.add_argument("--cooperative", type=bool, default=True, help="cooperative instance of RWARE")
    parser.add_argument("--shelf_columns", type=int, default=3, help="Number of columns in the warehouse")
    parser.add_argument("--column_height", type=int, default=3, help="Column height")
    parser.add_argument("--shelf_rows", type=int, default=2, help="Number of shelf rows in the warehouse")
    parser.add_argument("--msg_bits", type=int, default=0, help="Number of communication bits for each agent")
    parser.add_argument("--sensor_range", type=int, default=1, help="Range of each agents observation")
    parser.add_argument("--request_size", type=int, default=100, help="How many shelfs are simultaneously requested")
    parser.add_argument("--comms_radius", type=int, default=100, help="Maximum communication radius")
    parser.add_argument("--reward_type", type=str, default='Two_stage', help="Global, Individual, two_stage or two_stage_global")
    
    #Evironment:Flocking parameters
    parser.add_argument("--fully_cooperative", type=bool, default=True, help="fully cooperative instance of Flocking")
    parser.add_argument("--max_accel", type=float, default=0.5, help="maximum allowable agent acceleration")
